...
const CACHE = 'hogye-bus-alert-v29';
const CORE = ['/', '/index.html', '/styles.css?v=2.9.0', '/app.js?v=2.9.0', '/manifest.webmanifest', '/icons/icon-192.png', '/icons/icon-512.png', '/assets/future-bus-alert.mp3?v=2.9.0'];
